export const port_test = require('./port_test.jpg');

//logos
export const asu_logo = require('./asu_logo.png');
export const asu_fullname_logo = require('./asu_fullname_logo.png');
export const uiuc_logo = require('./uiuc_logo.png');
export const new_tsa = require('./new_tsa.jpg');
export const asu_fork_logo = require('./asu_fork_logo.png');

// tsa photos
export const asu_new_year = require('./asu_new_year.jpg');
export const asu_santa_monica = require('./asu_santa_monica.jpg');
export const asu_tisa_basketball = require('./asu_tisa_basketball.jpg');
export const french_home_party = require('./french_home_party.jpg');
export const asu_bowling = require('./asu_bowling.jpg');
export const asu_welcome_event = require('./asu_welcome_event.jpg');


// svg icons
export const filetype_py = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-filetype-py" viewBox="0 0 16 16">
...
export const filetype_java = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-filetype-java" viewBox="0 0 16 16">
...
export const filetype_html = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-filetype-html" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zm-9.736 7.35v3.999h-.791v-1.714H1.79v1.714H1V11.85h.791v1.626h1.682V11.85h.79Zm2.251.662v3.337h-.794v-3.337H4.588v-.662h3.064v.662zm2.176 3.337v-2.66h.038l.952 2.159h.516l.946-2.16h.038v2.661h.715V11.85h-.8l-1.14 2.596H9.93L8.79 11.85h-.805v3.999zm4.71-.674h1.696v.674H12.61V11.85h.79v3.325Z"/>
</svg>

export const filetype_css = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-filetype-css" viewBox="0 0 16 16">
...
export const filetype_cs = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-filetype-cs" viewBox="0 0 16 16">
...
export const filetype_cpp = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-filetype bi-file-earmark-code" viewBox="0 0 16 16">
